...
export const SetupReminderSection = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#001A33] to-[#004080] rounded-3xl p-6 lg:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-lg relative overflow-hidden border border-[#003366]">
      ...
      <div className="flex gap-4 lg:gap-6 items-start md:items-center z-10">
        ...
        <div className="w-12 h-12 lg:w-16 lg:h-16 bg-white/10 border border-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center shrink-0 shadow-inner">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 lg:h-8 lg:w-8 text-[#FFCC00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
