    ...
    <main className="flex flex-col w-full min-h-screen bg-[#F4F7FA] font-sans pb-12 md:pb-24">
      ...
      <div className="w-full max-w-4xl mx-auto px-4 md:px-6 lg:px-8 mt-6 md:mt-12">
        ...
        <div className="bg-white rounded-2xl md:rounded-3xl shadow-sm border border-gray-100 p-5 md:p-8 lg:p-12">
          ...
          {/* Body Content */}
          {/* MOBILE FIX: Tightened the gap between sections on mobile */}
          <div className="flex flex-col gap-6 md:gap-8 font-['Inter'] text-gray-600 leading-relaxed text-sm md:text-base">
            ...
            <section className="flex flex-col gap-2 md:gap-3">
              {/* MOBILE FIX: Scaled subheadings */}
              <h2 className="text-[#003366] text-xl md:text-2xl font-bold font-['Calistoga']">1. Information We Collect</h2>
              <p>To effectively suggest future courses and map your academic progression, we collect specific types of information:</p>
              {/* MOBILE FIX: Slightly reduced list indentation on mobile */}
            ...
            <section className="flex flex-col gap-2 md:gap-3">
              <h2 className="text-[#003366] text-xl md:text-2xl font-bold font-['Calistoga']">2. How We Use Your Information</h2>
            ...
            <section className="flex flex-col gap-2 md:gap-3">
              <h2 className="text-[#003366] text-xl md:text-2xl font-bold font-['Calistoga']">3. Data Storage and Security</h2>
              <p>
            ...
            <section className="flex flex-col gap-2 md:gap-3">
              <h2 className="text-[#003366] text-xl md:text-2xl font-bold font-['Calistoga']">4. Sharing Your Information</h2>
            ...
            <section className="flex flex-col gap-2 md:gap-3">
              <h2 className="text-[#003366] text-xl md:text-2xl font-bold font-['Calistoga']">5. Your Data Privacy Rights</h2>
            ...
            <section className="flex flex-col gap-2 md:gap-3">
              <h2 className="text-[#003366] text-xl md:text-2xl font-bold font-['Calistoga']">6. Changes to this Privacy Policy</h2>
              <p>
